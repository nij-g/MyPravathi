...
<html>
    ...
    <body>
        ...
        <%
                ...
                PreparedStatement ps = dbo.con.prepareStatement("SELECT * FROM donationseektb WHERE verified = ? ORDER BY reg_date DESC");
                ps.setString(1, "y");
        ...
        <div style="overflow-x:auto;" class="container">
            <table class="table table-striped" id="table1">
                ...
                <tbody>
                    <%
                                int count = 0;
                                String name, phone, email, category, state, date, datetime, amount, bank_name, accno, verifiedby;
                                do{
                                    count++;
                                    ...
                                    String adminst = rs.getString("a_approve");
                    %>
                    <tr>
                        <td><%= count %></td>
                        <td><%= category %></td>
                        ...
                        <td>
                            <%
                                if(adminst.equals("y")){
                            %>
                            <button name="approvedbtn" class="btn btn-sm btn-outline btn-success">
                                Approved <span class="glyphicon glyphicon-ok"></span>
                            </button>
                            <% } else{
                            %>
                            <button name="approvebtn" class="btn btn-outline btn-primary btn-sm" <%= "onClick='approve(`"+id+"`)'"%>>
                                Click To Approve
                            </button>
                            <% } %>
                        </td>
